...
```
    ...
    # A tibble: 120 × 4
       ...
       <fct>    <dbl> <dbl> <dbl>
     1 sp_11        1 0.860 0.714
     2 sp_11        1 0.860 0.866
     3 sp_11        1 0.860 0.767
     4 sp_11        1 0.860 0.869
     5 sp_11        1 0.860 1.09
     6 sp_11        1 0.860 1.04
     7 sp_11        1 0.860 0.922
     8 sp_11        1 0.860 0.772
     9 sp_11        1 0.860 0.810
    10 sp_11        1 0.860 0.757
    # ℹ 110 more rows
...
```
    ...
    Generalized Additive Model with 2 terms
      ...
      term       type           k   edf ref.edf statistic p.value
      <chr>      <chr>      <dbl> <dbl>   <dbl>     <dbl> <chr>
    1 Intercept  parametric    NA   1         1      1.06 0.29
    2 s(species) MRF           11  10.9      11    417.   <0.001 
