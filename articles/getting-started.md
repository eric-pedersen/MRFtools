...
![](getting-started_files/figure-html/plot-rw1-eg1-data-1.png)
...
![](getting-started_files/figure-html/plot-rw1-model-1-1.png)
...
![](getting-started_files/figure-html/plot-rw1-model-2-1.png)
...
![](getting-started_files/figure-html/plot-rw1-model-3-1.png)
...
![](getting-started_files/figure-html/sim-phylo-data-1.png)
...
```
    ...
    # A tibble: 120 × 4
       ...
       <fct>    <dbl> <dbl> <dbl>
     1 sp_11        1 0.563 0.434
     2 sp_11        1 0.563 0.793
     3 sp_11        1 0.563 0.483
     4 sp_11        1 0.563 0.266
     5 sp_11        1 0.563 0.586
     6 sp_11        1 0.563 0.617
     7 sp_11        1 0.563 0.585
     8 sp_11        1 0.563 0.699
     9 sp_11        1 0.563 0.550
    10 sp_11        1 0.563 0.387
    # ℹ 110 more rows
...
```
    ...
    Generalized Additive Model with 2 terms
      ...
      term       type           k   edf ref.edf statistic p.value
      <chr>      <chr>      <dbl> <dbl>   <dbl>     <dbl> <chr>
    1 Intercept  parametric    NA   1         1     -2.17 0.0323
    2 s(species) MRF           11  10.9      11    442.   <0.001 
